...
<body class="page-about">
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/GPETS.jpg');">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header" style="margin-top: 20px;">
          <h2>Grupo de Pesquisa e Extensão em Ensino, Tecnologia e Saúde</h2>
        </div>

        <div class="row gy-4" data-aos="fade-up">
          <div class="col-lg-4">
            <img src="assets/img/gpets-logo-vert.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8">
