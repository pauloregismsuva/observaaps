<footer id="footer" class="footer">
        ...
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <div class="social-links d-flex  mt-3">
              ...
              -->
              <a href="https://www.instagram.com/gpets_uva" class="instagram"><i class="bi bi-instagram"></i></a>
              <a href="mailto:observaaps@gmail.com" class="envelope"><i class="bi bi-envelope"></i></a>
            </div>
          </div>
    ...
    <div class="footer-legal">
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>ObservaAPS</span></strong>. Todos os direitos reservados
        </div>
        <div class="credits">
